...
import { getDeliverySettings } from '@/api/manager/restaurants/delivery-settings/get-delivery-settings'
import { updateDeliverySettings } from '@/api/manager/restaurants/delivery-settings/update-delivery-settings'
